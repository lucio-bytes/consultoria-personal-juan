...
export const StepsSection = () => {
  return (
    <section id="metodologia" className="relative overflow-hidden bg-surface py-24 md:py-32">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <p className="mt-6 text-lg text-muted-foreground">
            Independente do plano escolhido, todos os nossos alunos passam por essa montagem criteriosa e individualizada.
          </p>
        </motion.div>
          ...
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="mt-4 flex-1 text-sm leading-relaxed text-muted-foreground">{step.description}</p>
              </motion.div>
            );
          })}
        </div>
